...
struct FlashlightState_t
{
	FlashlightState_t()
	{
		...
		m_flShadowFilterSize = 1.0f; //usually 3.0f
...
enum RenderTargetSizeMode_t
{
	...
	RT_SIZE_FULL_FRAME_BUFFER=6,	// Same size as frame buffer, or next lower power of 2 if we can't do that. //originally 4
	RT_SIZE_OFFSCREEN=10,			// Target of specified size, don't mess with dimensions //originally 5
