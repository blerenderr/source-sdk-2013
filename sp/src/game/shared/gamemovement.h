...
#define GAMEMOVEMENT_JUMP_TIME				2040.0f		// ms approx - based on the 21 unit height jump //510
#define GAMEMOVEMENT_JUMP_HEIGHT			92.0f		// units usually 21.0f //maybe 92
