...
//
// Purpose: client-side camera weapon handling
//
//=============================================================================//
...
CLIENTEFFECT_REGISTER_BEGIN( PrecacheEffectCamera )
...
class C_CameraTape : public C_BaseCombatCharacter
{
	DECLARE_CLASS( C_CameraTape, C_BaseCombatCharacter );
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_CameraTape( const C_CameraTape & ); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT( C_CameraTape, DT_CameraTape, CCameraTape )
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_CameraTape::C_CameraTape( void )
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_CameraTape::OnDataChanged( DataUpdateType_t updateType )
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_CameraTape::DrawModel( int flags )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_CameraTape::ClientThink( void )
{
	m_bUpdated = false;
}
...
// Input  : &data - 
//-----------------------------------------------------------------------------
void CameraCrosshairLoadCallback( const CEffectData &data )
{
...
DECLARE_CLIENT_EFFECT( "CameraLoad", CameraCrosshairLoadCallback );
